...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-x-hidden">
      ...
      <main className="px-10 flex-1 flex justify-center py-5">
        <div className="flex flex-col max-w-[960px] flex-1">
          <h1 className="text-[#111417] tracking-light text-[28px] font-bold leading-tight px-4 text-center pb-3 pt-5">
            Searchin
          </h1>
